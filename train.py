...
def train(save_model_path=DIGIT_CLASSIFIER_PATH, mnist_data_path='mnist_data', print_accuracy=False):
    # mnist_data_path is not used, MNIST is loaded using torchvision.datasets
